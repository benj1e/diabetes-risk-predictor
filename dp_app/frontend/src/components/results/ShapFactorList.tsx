        ...
        <div className="border border-[var(--border-color)] bg-[var(--bg-surface)] p-6 sm:p-8 rounded-sm space-y-6">
            <div className="border-b border-[var(--border-color)] pb-4 space-y-1">
                ...
                <p className="text-xs sm:text-sm text-[var(--text-secondary)]">
                    Here's a breakdown of which health and lifestyle factors had
                    the most influence on your score, and in which direction.
                </p>
            </div>
            ...
            <div className="space-y-4">
                {items.map(([key, val]) => {
                    ...
                    const magnitudePercent = Math.min(
                        100,
                        Math.round((absVal / maxAbsValue) * 100),
                    );
